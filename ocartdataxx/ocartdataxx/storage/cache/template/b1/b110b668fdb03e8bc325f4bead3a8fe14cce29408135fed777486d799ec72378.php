...
class __TwigTemplate_45cf0af0cea2da576bc7f4eec6e8e2b00f24387ae88b14a76e27da1e3c2b1c9f extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t\t\t\t\t";
                ...
                echo twig_get_attribute($this->env, $this->source, $context["product"], "product_id", [], "any", false, false, false, 190);
                echo ", this)\"><i class=\"";
                echo twig_get_attribute($this->env, $this->source, $context["product"], "cart_btn_icon", [], "any", false, false, false, 190);
                echo "\"></i></button>
