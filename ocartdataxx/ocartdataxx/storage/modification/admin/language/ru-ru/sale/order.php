...
$_['heading_title']              = 'Заказы';
        ...
        $_['text_trans_link']          				    = 'Получить ссылку на оплату (Invoice)';
        $_['text_info_invoice_order']          			= 'Генерация инвойса для заказа: №';
        $_['text_invoice_base']          			    = 'Инвойс: ';
        $_['text_invoice_copy']          			    = 'Скопировать ссылку инвойса';
        $_['text_invoice_delete']          			    = 'Удалить инвойс';
        $_['text_info_trans']          			        = 'Информация по заказу: ';
        $_['text_info_invoice_add']          			= 'Создать инвойс';
