...
/* unishop2/template/extension/module/uni_news_category.twig */
class __TwigTemplate_32c469209f56b3ac4a0efff03c8a2e389a3ec5af0791e86f52d6f6d1fba61860 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        if (($context["categories"] ?? null)) {
            // line 2
            echo "\t<nav class=\"menu-module news-menu-module\">
...
\t\t\t\t\t<a href=\"";
                ...
                echo ((twig_in_filter(twig_get_attribute($this->env, $this->source, $context["category"], "category_id", [], "any", false, false, false, 6), ($context["category_arr"] ?? null))) ? ("active") : (""));
                echo "\">
\t\t\t\t\t\t";
                // line 7
...
\t\t\t\t\t\t";
                ...
                if (twig_get_attribute($this->env, $this->source, $context["category"], "children", [], "any", false, false, false, 8)) {
                    ...
                    echo ((twig_in_filter(twig_get_attribute($this->env, $this->source, $context["category"], "category_id", [], "any", false, false, false, 9), ($context["category_arr"] ?? null))) ? ("open") : (""));
                    echo "\">
...
\t\t\t\t\t";
                ...
                if (twig_get_attribute($this->env, $this->source, $context["category"], "children", [], "any", false, false, false, 15)) {
                    ...
                    echo ((twig_in_filter(twig_get_attribute($this->env, $this->source, $context["category"], "category_id", [], "any", false, false, false, 16), ($context["category_arr"] ?? null))) ? ("in") : (""));
                    echo "\">
\t\t\t\t\t\t\t";
                    // line 17
                    $context['_parent'] = $context;
                    ...
                    foreach ($context['_seq'] as $context["_key"] => $context["child"]) {
                        ...
                        echo ((twig_in_filter(twig_get_attribute($this->env, $this->source, $context["child"], "category_id", [], "any", false, false, false, 18), ($context["category_arr"] ?? null))) ? ("active") : (""));
                        echo "\">";
...
";
    ...
    {
        return "unishop2/template/extension/module/uni_news_category.twig";
    }
    ...
    {
        return new Source("", "unishop2/template/extension/module/uni_news_category.twig", "");
    }
}
