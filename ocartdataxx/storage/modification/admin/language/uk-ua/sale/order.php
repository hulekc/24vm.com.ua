...
$_['heading_title']              = 'Замовлення';
        ...
        $_['text_trans_link']          				    = 'Отримати посилання на оплату (Invoice)';
        $_['text_info_invoice_order']          		    = 'Генерація інвойсу для замовлення: №';
        $_['text_invoice_base']          			    = 'Інвойс: ';
        $_['text_invoice_copy']          			    = 'Копіювати посилання інвойсу';
        $_['text_invoice_delete']          			    = 'Видалити інвойс';
        $_['text_info_trans']          			        = 'Інформація по замовленню: ';
        $_['text_info_invoice_add']          			= 'Створити інвойс';
