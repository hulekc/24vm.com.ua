...
if ($this->config->has('module_ckeditor_replace_default_filemanager') && $this->config->get('module_ckeditor_replace_default_filemanager')) {
  return $this->load->controller('extension/cke_filemanager');
  exit;
}
