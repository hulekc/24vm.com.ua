$(function() {
	if(uniJsVars.showmore && $('.product-layout').length) {
		let btnHtml = '<div class="show-more" style="margin:15px 0 30px;text-align:center"><button type="button" class="show-more__btn btn btn-xl btn-default"><i class="show-more__icon fal fa-redo"></i><span>'+uniJsVars.showmore_text+'</span></button></div>';
