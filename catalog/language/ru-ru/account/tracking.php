...
$_['text_description'] = 'Чтобы зарабатывать по партнерской программе, вы должны разместить реферальную ссылку на нас. <br>Используйте инструмент указанный ниже, для создания реферальных ссылок для %s.';
