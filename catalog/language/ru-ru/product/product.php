...
$_['text_month']               = 'месяц';
$_['text_year']                = 'год';
$_['text_fast_delivery']       = 'Быстрая отправка';
$_['text_day_order']           = 'в день заказа';
$_['text_affordable_prices']   = 'Доступные цены';
$_['text_and_bonus_programs']  = 'и бонусные программы';
$_['text_convenient_payment']  = 'Удобная оплата';
$_['text_cash_or_card']        = 'наличными или карточками';
$_['text_return_guarantee']    = 'Гарантия возврата';
$_['text_14_days']             = '14 дней со дня покупки';
