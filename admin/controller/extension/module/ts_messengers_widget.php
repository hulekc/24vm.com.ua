...
class ControllerExtensionModuleTSMessengersWidget extends Controller {
    ...
    public function cssSettings($edit = array()) {
        ...
        if (isset($css_data['desc_size']) && !empty($css_data['desc_size'])) {
            $css .= ".ts-mw-button, .ts-mw-icon, .ts-mw-icon i, .ts-mw-icon .slides span img, .ts-mw-block.mw-no-bg img, .ts-mw-pulse {width:" . $css_data['desc_size'] . "px;" . "height:" . $css_data['desc_size'] . "px;}" . PHP_EOL;
        }
        ...
        if (isset($css_data['mobile_size']) && !empty($css_data['mobile_size'])) {
            $css .= ".ts-mw-button, .ts-mw-icon, .ts-mw-icon i, .ts-mw-icon .slides span img, .ts-mw-block.mw-no-bg img, .ts-mw-pulse {width:" . $css_data['mobile_size'] . "px;" . "height:" . $css_data['mobile_size'] . "px;}" . PHP_EOL;
