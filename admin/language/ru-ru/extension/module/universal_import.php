<?php
// Heading
$_['heading_title'] = '<strong style="color:#41637d">Universal Import/Export Pro 3.7.1</strong>';
...
$_['entry_xml_node_i'] = 'Установите узел xml для каждого элемента в вашем файле, например <product> или <item> (задайте значение без скобок). Система попытается определить его автоматически, просто измените его, если значение неверное';
...
$_['help_field_salt'] = 'Соль является дополнительной защитой для пароля, это поле должно быть установлено, если импортируемые вами пароли уже зашифрованы, если не установлено, ваши пользователи не смогут войти в систему.';
$_['entry_pwd_hash'] = 'Шифрование';
$_['entry_pwd_hash_i'] = 'Если ваш пароль зашифрован, отметьте соответствующее значение здесь и заполните поле соли, которое необходимо клиенту для входа в систему.';
