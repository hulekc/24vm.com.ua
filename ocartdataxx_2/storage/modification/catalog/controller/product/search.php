...
class ControllerProductSearch extends Controller {
	public function index() {
		...
		if (isset($this->request->get['search']) || isset($this->request->get['tag'])) {
			...
			$product_total = $this->{isset($uniset['search']['status']) ? 'model_extension_module_uni_search' : 'model_catalog_product'}->getTotalProducts($filter_data);

			$results = $this->{isset($uniset['search']['status']) ? 'model_extension_module_uni_search' : 'model_catalog_product'}->getProducts($filter_data);
